...
class Mixin:
    ...
    def delete_item(cls, item_id):
        ...
        db.session.commit()
        return 'deleted item {}.'.format(item_id)
...
class GroupModel(db.Model, Mixin):
    ...
    def delete_item(cls, item_id):
        ...
        super(GroupModel, cls).delete_item(item_id)
...
class StudentModel(db.Model, Mixin):
...
class CourseModel(db.Model, Mixin):
